...
contract CallAnything {
    ...
    // once we have the function selector, we have to encode the parameters of the function
    // this returns all the data that we need to put in the data field of the transaction
    // "use the transfer function with some address and an amount"
